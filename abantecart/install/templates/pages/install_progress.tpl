        ...
        <div class="col-md-12">
            <div class="panel panel-default">
                ...
                <div class="panel-heading">
                    <h2><i class="fa fa-gear fa-spin fa-fw"></i> Data Configuration
                ...
                <div class="panel-body panel-body-nopadding">
                    ...
                    <?php } ?>
                    <div id="error" class="hidden warning alert alert-error alert-danger"></div>

                    <label id="progressbar-heading" class="h5 heading">Saving settings and configuring AbanteCart database...</label>
...
<?php echo $progressbar_scripts; ?>
    ...
    <script type="text/javascript">
            ...
            $.ajax({
                ...
                success: function (response) {
                    if (response['ret_code'] == 50) {
                        ...
                        //all done need to wait for background process to finish
        ...
        function showError(response) {
            ...
            text += response;
            $('#error').html(text);
            //set sign to stop sequential ajax
            stop = true;
        }
