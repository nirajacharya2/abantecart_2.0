        ...
        <div class="col-md-9">
            <div class="panel panel-default">
                ...
                <div class="panel-heading">
                    <h2><i class="fa fa-gear fa-fw"></i> Configuration
                        <small>Provide setting below</small>
                    </h2>
                </div>
                <div class="panel-body panel-body-nopadding">
                    <form class="form-horizontal" action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form">
                        ...
                        <div class="form-group <?php echo $error['db_driver'] ? "has-error" : ''; ?>">
                        ...
                        <div class="form-group <?php echo $error['admin_secret'] ? "has-error" : ''; ?>">
                            <label class="control-label col-sm-4 col-xs-12">Admin section unique key:</label>
                            <div class="input-group col-sm-6 col-xs-12 afield">
                                <?php echo $form['admin_secret']; ?>
                            </div>
                            <?php if ( $error['admin_secret'] ) { ?>
                                <span class="help-block field_err"><?php echo $error['admin_secret']; ?></span>
                            <?php } ?>
                        </div>

                        <label class="h5 heading">3. Please enter a username and password for the administration.</label>

                        <div class="form-group <?php echo $error['username'] ? "has-error" : ''; ?>">
                        ...
                        <div class="form-group <?php echo $error['password_confirm'] ? "has-error" : ''; ?>">
