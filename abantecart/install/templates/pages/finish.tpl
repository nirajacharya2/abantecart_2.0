                ...
                <div class="panel-body panel-body-nopadding">
                    ...
                    <div class="container-fluid">
                        <div class="snapshots col-md-6">
                            <a href="<?php echo $storefront_url; ?>"><img src="templates/assets/images/storefront.png" alt="" width="250" style="border: none;"/></a><br/>
                            <a href="<?php echo $storefront_url; ?>">Your Online Shop</a>
                        </div>
                        <div class="snapshots col-md-6">
                            <a href="<?php echo $admin_url; ?>"><img src="templates/assets/images/admin.png" alt="" width="250" style="border: none;"/></a><br/>
                            <a href="<?php echo $admin_url; ?>">Login to your Control Panel</a>
                        </div>
                    </div>
                    ...
                    <div class="container-fluid">
                        ...
                        <div class="snapshots col-md-2">
                            <?php $url = $admin_url."&rt=extension/extensions/install&extension=default_stripe"; ?>
                            <a href="<?php echo $url; ?>" target="_new_admin"><img src="templates/assets/images/stripe_icon.png" alt="Install Stripe Payment" style="border: none;"/></a><br/>
                            <a href="<?php echo $url; ?>" target="_new_admin">Stripe</a>
                        </div>
                        <div class="snapshots col-md-2">
                            <?php $url = $admin_url."&rt=extension/extensions/install&extension=default_pp_standart"; ?>
                            <a href="<?php echo $url; ?>" target="_new_admin"><img src="templates/assets/images/pp_standart_icon.png" alt="Install Paypal Standart Payment" style="border: none;"/></a><br/>
                            <a href="<?php echo $url; ?>" target="_new_admin">Paypal</a>
                        </div>
                        <div class="snapshots col-md-2">
                            <?php $url = $admin_url."&rt=extension/extensions/install&extension=default_free_shipping"; ?>
                            <a href="<?php echo $url; ?>" target="_new_admin"><img src="templates/assets/images/free_shipping_icon.png" alt="Install Free Shipping" style="border: none;"/></a><br/>
                            <a href="<?php echo $url; ?>" target="_new_admin">Free Shipping</a>
                        </div>
                        <div class="snapshots col-md-2">
                            <?php $url = $admin_url."&rt=extension/extensions/install&extension=default_ups"; ?>
                            <a href="<?php echo $url; ?>" target="_new_admin"><img src="templates/assets/images/ups_icon.png" alt="Install UPS Shipping" style="border: none;"/></a><br/>
                            <a href="<?php echo $url; ?>" target="_new_admin">UPS</a>
                        </div>
                        <div class="snapshots col-md-2">
                            <?php $url = $admin_url."&rt=extension/extensions/install&extension=default_fedex"; ?>
                            <a href="<?php echo $url; ?>" target="_new_admin"><img src="templates/assets/images/fedex_icon.png" alt="Install FedEx Shipping" style="border: none;"/></a><br/>
                            <a href="<?php echo $url; ?>" target="_new_admin">FedEx</a>
                        </div>
                        <div class="snapshots col-md-2">
                            <?php $url = $admin_url."&rt=extension/extensions/extensions"; ?>
                            <a href="<?php echo $url; ?>" target="_new_admin"><img src="templates/assets/images/default_extension.png" alt="Many other options" style="border: none;"/></a><br/>
