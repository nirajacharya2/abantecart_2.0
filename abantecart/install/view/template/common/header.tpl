...
<script type="text/javascript" src="<?php $this->templateResource('assets/js/bootstrap.min.js');?>"></script>

</head>
<body>
<div class="container" id="container">
  <header><img src="<?php echo $this->templateResource('assets/images/logo.png'); ?>" alt="AbanteCart" title="AbanteCart" /></header>
