<div class="form-group action-buttons">
	<div class="col-md-12">
		<button id="checkout_btn"
				...
				class="btn btn-orange pull-right lock-on-click"
				title="<?php echo $button_confirm->text ?>">
			<i class="fa fa-check"></i>
            <?php echo $button_confirm->text; ?>
		</button>
		<a id="<?php echo $button_back->name ?>"
		   href="<?php echo $button_back->href; ?>"
		   class="btn btn-default"
		   title="<?php echo $button_back->text ?>">
...
<script type="text/javascript">
	function confirmSubmit() {
		...
		$.ajax({
			...
			success: function () {
				location = '<?php echo $continue_url; ?>';
			},
