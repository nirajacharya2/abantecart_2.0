...
if ($query->row['language_id']) {
    $this->session->data['error'] = "Error: Language with ".$lng_code
        ." code is already installed! Can not install duplicate languages! "
        ."Uninstall this extension before attempting again.";
...
$this->db->query(
    "INSERT INTO ".$this->db->table_name('languages')." 
...
$xml = simplexml_load_file(__DIR__.DS.'menu.xml');
$routes = [
...
$this->db->query("INSERT INTO ".$this->db->table_name('country_descriptions')." 
...
$this->db->query("INSERT INTO ".$this->db->table_name('zone_descriptions')."
...
$this->db->query(
    "INSERT INTO ".$this->db->table_name('stock_statuses')."
...
$this->db->query(
    "INSERT INTO ".$this->db->table_name('length_class_descriptions')."
...
$this->db->query(
    "INSERT INTO ".$this->db->table_name('weight_class_descriptions')."
...
$this->db->query(
    "INSERT INTO ".$this->db->table_name('order_statuses')."
...
$this->db->query("INSERT INTO ".$this->db->table_name('page_descriptions')."
...
$this->db->query("INSERT INTO ".$this->db->table_name('global_attributes_type_descriptions')."
...
$this->db->query("INSERT INTO ".$this->db->table_name('form_descriptions')."
(`form_id`, `language_id`, `description`) VALUES
(2, ".$new_language_id.",'Свяжитесь с Нами');
");

$this->db->query("INSERT INTO ".$this->db->table_name('field_descriptions')."
