...
class ControllerPagesSettingStore extends AController
{
    ...
    public function update()
    {
        ...
        if ($this->request->get['store_id'] == 0) {
            abc_redirect($this->html->getSecureURL('setting/setting',
        ...
        if ($this->request->is_POST() && $this->_validateForm()) {
            ...
            $this->session->data['success'] = $this->language->get('text_success');
            abc_redirect($this->html->getSecureURL('setting/store/update',
    ...
    public function getForm()
    {
        ...
        if (isset($this->request->get['store_id'])) {
            $this->data['delete'] =
                $this->html->getSecureURL('setting/store/delete', '&store_id='.$this->request->get['store_id']);
            $this->data['edit_settings'] =
                $this->html->getSecureURL('setting/setting', '&store_id='.$this->request->get['store_id']);
        } else {
            $this->data['delete'] = '';
            $this->data['edit_settings'] = '';
        }
        ...
        if (!isset($this->request->get['store_id'])) {
            ...
            $this->data['cancel'] =
                $this->html->getSecureURL('setting/store/update', '&store_id='.$this->request->get['store_id']);
        }
        ...
        if ($this->data['delete']) {
            $this->data['delete_store_button'] = $this->html->buildElement([
                ...
                'text'  => '&nbsp;',
                'style' => 'icon_delete',
                'href'  => $this->html->getSecureURL('setting/store/delete',
                    '&store_id='.$this->request->get['store_id']),
            ]);
        }
        ...
        if (!isset($this->request->get['store_id'])) {
            ...
            $this->data['update'] =
                $this->html->getSecureURL('listing_grid/store/update_field', '&id='.$this->request->get['store_id']);
            $form = new AForm('HS');
        }
    ...
    protected function _validateDelete()
    {
        ...
        $store_total = Order::where('store_id', '=', $this->request->get['store_id'])->count();
        if ($store_total) {
