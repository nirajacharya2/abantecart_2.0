...
/**
 * Class ControllerResponsesListingGridGlobalSearchResult
 *
...
class ControllerResponsesListingGridGlobalSearchResult extends AController
{
    ...
    public function main()
    {
        ...
        $results = $this->model_tool_global_search->getResult(
            $this->request->get['search_category'],
        ...
        if (!isset($this->session->data['search_totals'][$this->request->get['search_category']])) {
            $total = $this->model_tool_global_search->getTotal(
                $this->request->get['search_category'],
                $this->request->get['keyword']
            );
        } else {
            ...
            foreach ($r['result'] as $item) {
                ...
                if ($id == 'commands') {
                    ...
                    $item['controller'] =
                        ...
                        ? $this->html->getSecureURL($result_controllers[$tmp_id]['response'],'&'.implode('&', $tmp))
                        : '';
