...
<div class="contentpanel">
	...
	<div class="registerbox form-horizontal ">
		<fieldset>
            ...
            foreach ($form['fields']['address'] as $field_name => $field) { ?>
				<div class="form-group <?php if (${'error_'.$field_name}) {
                    echo 'has-error';
                } ?>">
					<label class="control-label col-sm-4"><?php echo ${'entry_'.$field_name}; ?></label>
					<div class="input-group col-sm-4">
	...
	<div class="registerbox form-horizontal">
		<fieldset>
            <?php if (isset($form['fields']['general']['loginname'])) { ?>
				<div class="form-group <?php if ($error_loginname) {
                    echo 'has-error';
                } ?>">
            ...
            <?php } ?>
			<div class="form-group <?php if ($error_password) {
                echo 'has-error';
            } ?>">
			...
			<div class="form-group <?php if ($error_confirm) {
                echo 'has-error';
            } ?>">
	...
	<div class="registerbox form-horizontal">
        ...
        <?php if ($form['fields']['newsletter']['captcha']) { ?>
			<fieldset>
				<div class="form-group <?php if ($error_captcha) {
                    echo 'has-error';
                } ?>">
		...
		<div class="col-md-12">
            <?php if ($text_agree) { ?>
				<label class="col-md-6 mt20 mb40">
                    <?php echo $text_agree; ?>&nbsp;<a href="<?php echo $text_agree_href; ?>"
													   onclick="openModalRemote('#privacyPolicyModal','<?php echo $text_agree_href; ?>'); return false;"><b><?php echo $text_agree_href_text; ?></b></a>
			...
			<div class="col-md-2 mt20 mb40">
				<button class="btn btn-orange pull-right lock-on-click" title="<?php echo $form['continue']->name ?>"
						type="submit">
