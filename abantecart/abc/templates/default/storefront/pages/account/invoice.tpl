...
<div class="contentpanel">
	...
	<div class="form-group">
		<div class="mt20 mb40">
		    ...
		    <a href="" class="btn btn-default mr10 pull-right" data-toggle="modal" data-target="#cancellationModal"
		       title="<?php echo $button_order_cancel->text ?>">
		    	<i class="<?php echo $button_order_cancel->{'icon'}; ?>"></i>
		    	<?php echo $button_order_cancel->text ?>
		    </a>
				<div id="cancellationModal" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="cancellationModalLabel" aria-hidden="true">
					<div class="modal-dialog">
						<div class="modal-content">
							<div class="modal-header">
								<button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
								<h3 id="returnPolicyModalLabel"><?php echo $text_order_cancellation; ?></h3>
							</div>
							<div class="modal-body"><?php echo $text_order_cancellation_confirm; ?></div>
							<div class="modal-footer">
								...
								<button class="btn btn-orange pull-right" onclick="location='<?php echo $order_cancellation_url;?>';"><i class="fa fa-arrow-right"></i>&nbsp;<?php echo $button_continue->text; ?></button>
							</div>
						</div>
					</div>
				</div>
