...
if ($download_id != 'new') { ?>
	<tr id="download_<?php echo $download_id; ?>" class="optionRow">
		...
		<td>
			...
			<img src="<?php $this->templateResource('assets/images/icons/Bluepin.png'); ?>" alt="<?php echo $push_to_customers->text; ?>"/></a>
			<?php } ?>
			<a href="<?php echo $delete_unmap_href; ?>" class="delete  pull-right"
				title="<?php echo $text_delete_or_refuse; ?>">
			<img src="<?php echo $this->templateResource('assets/images/icons/icon_grid_delete.png'); ?>" alt="<?php echo $text_delete; ?>"/></a>
		</td>
	</tr>
<?php } else { ?>
