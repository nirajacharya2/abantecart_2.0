...
class ModelToolDatasetsManager extends Model
{
    ...
    public function getDatasetInfo($dataset_id)
    {
        ...
        $sql = "SELECT dataset_name, dataset_key FROM ".$this->db->table_name("datasets")." WHERE dataset_id = "
            .$dataset_id;
        ...
        if ($cols) {
            foreach ($cols as $column) {
                $output['dataset_column_definition'][] =
                    [$column['dataset_column_name'] => $column['dataset_column_type']];
            }
        }
