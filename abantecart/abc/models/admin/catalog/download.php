...
class ModelCatalogDownload extends Model
{
    ...
    public function addDownload($data)
    {
        ...
        $this->db->query(
            "INSERT INTO ".$this->db->table_name('downloads')."
    ...
    public function deleteDownload($download_id)
    {
        ...
        $this->db->query("DELETE FROM ".$this->db->table_name("downloads")." WHERE download_id = '".(int)$download_id
            ."'");
        $this->db->query("DELETE FROM ".$this->db->table_name("download_descriptions")." WHERE download_id = '"
            .(int)$download_id."'");
        $this->db->query("DELETE FROM ".$this->db->table_name("download_attribute_values")." WHERE download_id = '"
            .(int)$download_id."'");
    ...
    public function getDownloads($data = [], $mode = 'default')
    {
        ...
        if ($mode == 'total_only') {
            ...
            $total_sql = 'dd.*, d.*, (SELECT COUNT(*) as cnt FROM '.$this->db->table_name("products_to_downloads")
    ...
    public function addDownloadAttributeValues($download_id, $data)
    {
        ...
        foreach ($attributes as $attribute) {
            if (isset($data[$attribute['attribute_id']])) {
                ...
                $this->db->query(
                    "INSERT INTO ".$this->db->table_name('download_attribute_values')." 
                        (attribute_id, download_id, attribute_value_ids)
                    VALUES 
